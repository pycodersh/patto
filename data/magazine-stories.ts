...
export const magazineStories: MagazineStory[] = [
  // ── Story 1 · 새로운 시작 (p1-5) ───────────────────────────────────────────
  {
    ...
    imageAlt: 'An open journal and pen on a desk at night',
    slideImages: slides(1, [
      { id: '1506784983877-45594efa4cbe', alt: 'An open journal and pen on a desk at night', paras: [1, 2] },
      { id: '1470071459604-3b5ec3a7fe05', alt: 'Soft sunrise light over a calm horizon', paras: [3] },
      { id: '1454165804606-c3d57bc86b40', alt: 'Notes and a plan written out on paper', paras: [4] },
      { id: '1434030216411-0b793f4b4173', alt: 'A hand writing the first lines on a fresh page', paras: [5] },
    ]),
  ...
  // ── Story 2 · 나를 만드는 시간 (p6-10) ──────────────────────────────────────
  {
    ...
    imageAlt: 'Two friends laughing together at a table',
    slideImages: slides(2, [
      { id: '1543007630-9710e4a00a20', alt: 'Two friends laughing together at a table', paras: [1] },
      { id: '1511632765486-a01980e01a18', alt: 'A warm conversation in a cozy café', paras: [2, 3] },
      { id: '1481627834876-b7833e8f5570', alt: 'A quiet moment reading by the window', paras: [4] },
      { id: '1522708323590-d24dbb6b0267', alt: 'A calm, cozy corner with warm light', paras: [5] },
    ]),
  ...
  // ── Story 3 · 일상의 기초 (p11-15) ─────────────────────────────────────────
  {
    ...
    imageAlt: 'A warm cup of coffee on a table in the morning',
    slideImages: slides(3, [
      { id: '1495474472287-4d71bcdd2085', alt: 'A warm cup of tea on a table in the morning', paras: [1, 2] },
      { id: '1493663284031-b7e3aefcae8e', alt: 'A bright, tidy kitchen at home', paras: [3] },
      { id: '1556909114-f6e7ad7d3136', alt: 'Preparing a simple breakfast in the kitchen', paras: [4] },
  ...
  // ── Story 4 · 계획과 준비 (p16-20) ─────────────────────────────────────────
  {
    ...
    imageAlt: 'A tidy office desk ready for tomorrow',
    slideImages: slides(4, [
      { id: '1497366754035-f200968a6e72', alt: 'A tidy office desk ready for tomorrow', paras: [1] },
      { id: '1486406146926-c627a92ad1ab', alt: 'City lights through an office window at night', paras: [2] },
      { id: '1488190211105-8b0e65b80b4e', alt: 'Working late on a laptop with notes', paras: [3] },
      { id: '1531973576160-7125cd663d86', alt: 'A quiet workspace late in the evening', paras: [4, 5] },
    ]),
  ...
  // ── Story 5 · 생각과 느낌 (p21-25) ─────────────────────────────────────────
  {
    ...
    imageAlt: 'A thoughtful moment looking out the window',
    slideImages: slides(5, [
      { id: '1517021897933-0e0319cfbc28', alt: 'A thoughtful moment looking out the window', paras: [1] },
      { id: '1499209974431-9dddcece7f88', alt: 'Sitting quietly, lost in thought', paras: [2, 3] },
      { id: '1455390582262-044cdead277a', alt: 'Writing down a quiet decision', paras: [4] },
      { id: '1512820790803-83ca734da794', alt: 'A calm desk with an open book', paras: [5] },
    ]),
  ...
  // ── Story 6 · 판단과 의견 (p26-30) ─────────────────────────────────────────
  {
    ...
    imageAlt: 'Two people discussing a decision together',
    slideImages: slides(6, [
      { id: '1519389950473-47ba0277781c', alt: 'Two people discussing a decision together', paras: [1] },
      { id: '1521017432531-fbd92d768814', alt: 'Friends weighing the pros and cons', paras: [2, 3] },
      { id: '1517245386807-bb43f82c33c4', alt: 'A page of notes and crossed-out ideas', paras: [4] },
      { id: '1524995997946-a1c2e315a42f', alt: 'A calm desk for thinking it through', paras: [5] },
    ]),
  ...
  // ── Story 7 · 조건과 결과 (p31-35) ─────────────────────────────────────────
  {
    ...
    slideImages: slides(7, [
      ...
      { id: '1518495973542-4542c06a5843', alt: 'Sunlight breaking through the trees', paras: [2, 3] },
      { id: '1501785888041-af3ef285b470', alt: 'A calm lake seen from the trail', paras: [4] },
      { id: '1470071459604-3b5ec3a7fe05', alt: 'A wide mountain view at the top', paras: [5] },
    ]),
  ...
  // ── Story 8 · 부탁과 제안 (p36-40) ─────────────────────────────────────────
  {
    ...
    imageAlt: 'A beautifully set dinner table',
    slideImages: slides(8, [
      { id: '1466637574441-749b8f19452f', alt: 'A beautifully set dinner table', paras: [1, 2] },
      { id: '1509042239860-f550ce710b93', alt: 'A drink shared over a warm meal', paras: [3] },
      { id: '1511920170033-f8396924c348', alt: 'A cozy table in soft restaurant light', paras: [4] },
      { id: '1507003211169-0a1dd7228f2d', alt: 'A friendly face at the dinner table', paras: [5] },
    ]),
  ...
  // ── Story 9 · 질문하기 (p41-45) ────────────────────────────────────────────
  {
    ...
    slideshowInterval: 10,
    slideshowKenBurns: true,
    imageUrl: U('1436491865332-7a61a109cc05'),
    imageAlt: 'A window view from a plane before takeoff',
    slideImages: slides(9, [
      { id: '1436491865332-7a61a109cc05', alt: 'A window view from a plane before takeoff', paras: [1] },
      { id: '1570710891163-6d3b5c47248b', alt: 'Travelers heading through the terminal', paras: [2, 3] },
      { id: '1553877522-43269d4ea984', alt: 'A bright departure hall full of energy', paras: [4] },
      { id: '1444653614773-995cb1ef9efa', alt: 'A new city waiting to be explored', paras: [5] },
    ]),
  ...
  // ── Story 10 · 감정 표현 (p46-50) ──────────────────────────────────────────
  {
    ...
    imageAlt: 'A hopeful moment full of excitement',
    slideImages: slides(10, [
      { id: '1530103862676-de8c9debad1d', alt: 'A hopeful moment full of excitement', paras: [1] },
      { id: '1492684223066-81342ee5ff30', alt: 'Celebrating a new chapter ahead', paras: [2, 3] },
      { id: '1428592953211-077101b2021b', alt: 'A quiet, reflective evening by the window', paras: [4] },
      { id: '1499346030926-9a72daac6c63', alt: 'Looking out toward an unknown tomorrow', paras: [5] },
    ]),
